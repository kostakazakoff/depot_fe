        ...
        >
            <div className="modal-content p-5">
                ...
                >
                    ...
                    <section
                        {...getRootProps({
                            className: 'w-100 shadow rounded p-4 position-relative',
                        })}
                    >
                    ...
                    <section className='overflow-y-auto d-flex justify-content-start align-items-center gap-4 position-relative'>
                        {files.map(file => (
                            <div
                                key={file.name}
